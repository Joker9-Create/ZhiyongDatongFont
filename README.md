...
### ⚠️分发重要提示
1. **仅使用字体生成图片、海报、印刷、网页渲染、APP界面展示，不需要附带协议文件。**
2. **如果你对外分发、拷贝、打包发布字体文件本身（原始TTF或修改后的衍生TTF），必须随同字体副本一起附带本仓库的 `LICENSE.txt` 协议文件。**
3. 衍生修改版本字体禁止继续使用「智勇大同体 / Zhiyong Datong」作为字体家族名称，必须更换全新字体名称，并且衍生作品继续使用 SIL‑OFL‑1.1 协议开源。
4. 字体文件本身不允许单独售卖。

> License完整原版文件见仓库根目录 [LICENSE.txt](./LICENSE.txt)
> 协议FAQ参考：https://openfontlicense.org/ofl‑faq/
